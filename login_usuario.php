...
<div class="jumbotron" style="height:100px; background-color:#4c4c4c; border-bottom: 4px solid green;">
          <div class="container">
            <div class="row">
                <div class="col-md-8 hidden-xs">
                 <h2 class="green_t"> Iniciar Sesión</i></h2>
                </div>
                <div class="col-md-4 col-xs-12">
                  <center><img class="rounded-circle float-left img-fluid" src="images/logo1.png" alt="Circle image" style="width:220px; height:140px;"></center>
                </div>
            </div>
          </div>
    ...
    <!-- Top content -->
        <div class="top-content">
            <div class="inner-bg">
                <div class="container" >
                    <form method="post" action="validarUsuario.php" role="login" class="form-horizontal">
                        <div class="form-group">
                          <center><img class="rounded-circle" src="images/sesion.jpg"  style="width:200px; height:140px;" ></center>
                          <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-2 col-md-offset-5">
									<button type="submit" name="go" class="btn_border btn_default active">Entrar</button>
                                   
                                </div>
								<div class="col-md-2 col-md-offset-5">
									&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; <a href="registrar.php" class="green_t">Registrarse</a> 
								</div>
                            </div>
                    </form> 
                </div>

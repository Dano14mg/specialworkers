    ...
    <body>
		<div class="container">
			<!--<div class="navbar-header text" >-->
                <!--<h1 style="color:white;"><strong>Special Workers</strong></h1>-->
                <img src="images/logo1.png" height="150px">
			<!--</div>-->
		</div>
            ...
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-7 ">
                            <p ><h3 style="color: #2A0A0A;"><strong>
                            Se parte de Special Workers, una aplicación que ayuda a grupos vulnerables <br>
                            (Personas con discapacidad), a participar en el mundo laboral sin que las <br>
                            limitaciones que presentan impidan realizar el trabajo que ellos solicitan. <br>
                            Integrate y conoce los beneficios.</strong></h3></p>    
                            ...
                            <div class="form-bottom">
			                    <form role="login" action="validarUsuario_empresa.php" method="post" class="registration-form">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" name="usuario" placeholder="ID-Usuario" class="form-first-name form-control" id="form-first-name" required>
			                        </div>
			                        <div class="form-group">
			                        	
			                        	<input type="password" name="passwd" placeholder="Contraseña" class="form-last-name form-control" id="form-last-name" required>
			                         </div>
                                     <center>

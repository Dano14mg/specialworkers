                ...
                <div class="container" >
                  <br>
                    <form method="post" action="validarRegistro.php" role="login" class="form-horizontal">
						...
						<div class="form-group"><div class="col-md-12 col-md-offset-4"><font color="red"><li>Incorrecta confirmación de contraseñas</li></font></div></div>
                            <br><br>
                            <div class="form-group">
